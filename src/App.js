...
const App = () => {
  ...
  const columnDefs = [
    ...
    {headerName: 'Screen Size', field: 'screen-size', width: 70, filter: 'agNumberColumnFilter'},
    {headerName: 'Resolution', field: 'resolution', width: 100},
    {headerName: 'IPS Screen?', field: 'screen-has-ips', width: 70, cellRenderer: renderBoolean},
    {headerName: 'Display', field: 'display-type'},
    {headerName: 'Memory Size', field: 'memory-size', width: 70},
    {headerName: 'Hard Drive Type', field: 'hard-drive-type'},
    {headerName: 'Hard Drive Size', field: 'hard-drive-size', width: 70},
    {headerName: 'Processor Brand', field: 'processor-brand', width: 70},
    {headerName: 'Processor Range', field: 'processor-range', width: 70},
    ...
    {headerName: 'Refurbished?', field: 'refurbished', width: 70,
     cellRenderer: renderBoolean},
